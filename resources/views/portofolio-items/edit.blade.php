        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="post" action="{{ route('portofolio-items.update', $portofolioItem) }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                :value="old('name', $portofolioItem->name)" required autofocus autocomplete="name" />
                        ...
                        <div>
                            ...
                            <x-text-area id="content" name="content"
                                class="mt-1 block w-full">{{ old('content', $portofolioItem->content) }}</x-text-area>
                        ...
                        <div id="images" class="grid gap-2 grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2">
                            @foreach ($portofolioItem->images as $image)
                                <div>
                                    ...
                                    <a href="{{ route('images.delete', [$image, $portofolioItem, 'portofolio-items']) }}"
