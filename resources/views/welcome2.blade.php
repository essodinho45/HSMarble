...
<body>
    ...
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between">
            <a class="py-2" href="https://getbootstrap.com/docs/5.0/examples/product/#" aria-label="Product">
            ...
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Tour</a>
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Product</a>
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Features</a>
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Enterprise</a>
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Support</a>
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Pricing</a>
            <a class="py-2 d-none d-md-inline-block"
                href="https://getbootstrap.com/docs/5.0/examples/product/#">Cart</a>
        </nav>
    </header>
